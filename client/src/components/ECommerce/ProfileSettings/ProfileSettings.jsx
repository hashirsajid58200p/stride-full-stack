...
export default function ProfileSettings({ user, dbUser, setDbUser, onDeleteAccount }) {
  ...
  const handleFileUpload = async (file) => {
    ...
    formData.append("folder", "stride/profiles");
  ...
  const avatars = [
    "https://res.cloudinary.com/dwagwbklz/image/upload/v1779215293/stride/avatars/yz2oku456mj3xh4qamya.jpg",
    "https://res.cloudinary.com/dwagwbklz/image/upload/v1779215294/stride/avatars/bevdnnc2b8jh0bpcb1dv.jpg",
    "https://res.cloudinary.com/dwagwbklz/image/upload/v1779215296/stride/avatars/p6tiuexy6pkr4ewe9ukp.jpg",
    "https://res.cloudinary.com/dwagwbklz/image/upload/v1779215300/stride/avatars/z0jkdjffyn9ooevaohkx.jpg",
    "https://res.cloudinary.com/dwagwbklz/image/upload/v1779215287/stride/avatars/yuv5mpzisuuxqsbdozya.jpg",
    "https://res.cloudinary.com/dwagwbklz/image/upload/v1779215289/stride/avatars/cnswpv2ucstlk58bz7id.png",
    "https://res.cloudinary.com/dwagwbklz/image/upload/v1779215291/stride/avatars/fuwsj6czu1mgoz8svbls.png",
    "https://res.cloudinary.com/dwagwbklz/image/upload/v1779215292/stride/avatars/dtwhnqpxxfvvb2supd43.png"
  ];
